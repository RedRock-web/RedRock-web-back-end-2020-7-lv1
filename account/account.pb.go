...
type StatusWithData struct {
	...
	IsRegistered string `protobuf:"bytes,1,opt,name=is_registered,json=isRegistered,proto3" json:"is_registered,omitempty"`
...
func (x *StatusWithData) GetIsRegistered() string {
	if x != nil {
